      ...
      <div className='flex flex-col ml-20'>
                  ...
                  <div className='flex flex-col'>
                    ...
                    <div className='flex ml-[100px]' >
                      ...
                      <button onClick={handleUpdateEmail} className='my-10 mr-[350px] bg-amber-400 border-amber-500 text-slate-50 rounded-md w-[200px] h-[30px] hover:scale-105 active:scale-95'>
                        メールアドレスを変更する
                      </button>
                      <button onClick={handleUpdatePassword} className='my-10 bg-rose-400 border-rose-500 text-slate-50 rounded-md w-[200px] hover:scale-105 active:scale-95'>
                        パスワードを変更する
                      </button>
                    </div>
                  </div>
